...
function generateComplianceReport(walletData, stream) {
  ...
  // ââ Risk score banner ââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  // ââ Account summary ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  // ââ Risk flags âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  // ââ Detailed findings ââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  sectionTitle(doc, "DETAILED FINDINGS", MARGIN);
  for (const detail of risk.details) {
    doc.fontSize(9).font("Helvetica").fillColor("#334455")
       .text(`â¢ ${detail}`, MARGIN, doc.y, { width: W - MARGIN * 2 });
    doc.moveDown(0.4);
  }

  // ââ Recent transactions ââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  if (transactions.length > 0) {
    sectionTitle(doc, "RECENT TRANSACTIONS", MARGIN);
    tableWithHeader(doc,
      ["Signature", "Amount", "Status"],
      transactions.slice(0, 8).map(t => [
        t.signature ? `${t.signature.slice(0, 14)}â¦` : "â",
        t.lamport   ? `${(t.lamport / 1e9).toFixed(4)} SOL` : "â",
        t.status || "â",
      ]),
      MARGIN, W
    );
  ...
  // ââ Footer with watermark (IP protection) ââââââââââââââââââââââââââââââââââââ
  ...
  for (let i = 0; i < pages.count; i++) {
    ...
    doc.fontSize(7).font("Helvetica-Bold").fillColor("#B8691C")
       .text(
         "Solvera Â· Proprietary AML Intelligence Engine Â· Â© 2024 Solvera. All rights reserved.",
...
function levelDesc(level) {
  return {
    ...
    MODERATE: "Some risk signals present â review recommended.",
    ELEVATED: "Multiple risk factors identified â enhanced due diligence required.",
    HIGH:     "Severe risk indicators â escalate to compliance team immediately.",
